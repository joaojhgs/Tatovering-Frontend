...
export default function CadastroStep4({ handleSubmit, goBack }) {
                ...
                <Row gutter={[24, 0]}>
                    <Col span={24} md={12}>
                        <Form.Item name="nome" label="Nome" required>
                            <Input
                                type="text"
                                placeholder="Insira o nome do estúdio"
                            />
                        </Form.Item>
                    </Col>
                    <Col span={24} md={12}>
                        <Form.Item name="email" label="Email" required>
                            <Input
                                type="text"
                                placeholder="Insira o email do estúdio"
                            />
                        </Form.Item>
                    </Col>
                    <Col span={24} md={12}>
                        <Form.Item name="endereco" label="Endereço" required>
                            <Input
                                type="text"
                                placeholder="Insira o endereço do estúdio"
                            />
                        </Form.Item>
                    </Col>
                    <Col span={24} md={12}>
                        <Form.Item name="descricao" label="Descrição" required>
                            <Input
                                type="text"
                                placeholder="Insira a descrição do estúdio"
                            />
                        </Form.Item>
                    </Col>
                    <Col span={24}>
