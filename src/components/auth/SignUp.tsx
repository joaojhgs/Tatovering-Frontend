  ...
  return (
    <Card className="z-10 w-full max-w-md space-y-8 rounded-xl p-10">
      ...
      <div className="flex flex-row items-center justify-center space-x-3">
        <span className="inline-flex size-11 cursor-pointer items-center justify-center rounded-full bg-blue-900 text-lg  font-bold  text-white transition duration-300 ease-in hover:shadow-lg">
          <img
            className="size-4"
        ...
        <span className="inline-flex size-11 cursor-pointer items-center justify-center rounded-full bg-blue-400 text-lg  font-bold text-white transition duration-300 ease-in hover:shadow-lg">
          <img
            className="size-4"
        ...
        <span className="inline-flex size-11 cursor-pointer items-center justify-center rounded-full bg-blue-500 text-lg  font-bold text-white transition duration-300 ease-in hover:shadow-lg">
          <img
