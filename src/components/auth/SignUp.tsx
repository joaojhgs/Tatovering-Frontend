            ...
            <Card className="max-w-md w-full space-y-8 p-10 rounded-xl z-10">
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        >
                            <Input type='email' className="w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" prefix={<UserOutlined className="site-form-item-icon" />} placeholder="email@gmail.com" />
                        </Form.Item>
                    </div>
                    ...
                    <div>
                        <Button type="primary" htmlType="submit" size='large' className="w-full flex justify-center text-gray-100 p-4 rounded-full tracking-wide
